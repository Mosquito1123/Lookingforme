    ...
    */
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        if let font = UIFont(name: "Futura", size: 20), let largeFont = UIFont(name: "Futura", size: 30) {
            self.largeTitleTextAttributes = [NSAttributedString.Key.font:largeFont, NSAttributedString.Key.foregroundColor:UIColor.white]
            self.titleTextAttributes = [NSAttributedString.Key.font:font, NSAttributedString.Key.foregroundColor:UIColor.white]
        }
    }
